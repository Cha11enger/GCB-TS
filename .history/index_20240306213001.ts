...
app.use(session({
  secret: process.env.SESSION_SECRET, // Replace 'your secret' with a real secret key
  resave: false,
  saveUninitialized: true,
  cookie: { secure: 'auto' } // Use 'true' if you are on HTTPS/SSL, 'auto' to delegate to express-session
}));
// Set up routes
app.use('/api', router);
// app.use(repoRoutes);

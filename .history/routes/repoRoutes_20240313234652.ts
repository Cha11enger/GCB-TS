...
import User from '../models/User'; // Make sure the import path matches your project structure
...
router.post('/analyze', async (req: Request, res: Response) => {
  ...
  req.session.user = { accessToken: "someAccessTokenValue" };
  const accessToken = req.session.user?.accessToken || process.env.GITHUB_PAT;

...
passport.use(new GitHubStrategy({
  ...
  const githubData: GitHubProfileData = profile.interface ExtendedProfile extends Profile {
  _json: any; // replace 'any' with the actual type if known
}

// Then, when you get the profile object, you can cast it to the ExtendedProfile:

const profile = getProfile() as ExtendedProfile; // replace getProfile() with the actual function that returns the profile

// Now you can access _json property:
console.log(profile._json); as GitHubProfileData;

  ...
  try {
    ...
    if (user) {
      ...
      const newUser = new User({
        ...
        username: userProfile._json.login, // Use login from _json
        profileUrl: userProfile._json.html_url, // Use html_url from _json
        avatarUrl: userProfile._json.avatar_url,
      });
      await newUser.save();

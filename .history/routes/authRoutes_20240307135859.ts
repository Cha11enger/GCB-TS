...
// GitHub callback route after authentication is successful send response to the client with the user details and token and save the user details in the database and se

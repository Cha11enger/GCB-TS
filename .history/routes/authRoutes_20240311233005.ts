...
import User, { IUser } from '../models/User'; // Ensure IUser is correctly exported from your User model.

const router = express.Router();

// Extending the Profile interface to include _json with expected properties
...
passport.deserializeUser((id: string, done: (err: any, user?: IUser | null) => void) => {

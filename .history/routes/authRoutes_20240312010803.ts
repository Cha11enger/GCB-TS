...
import { Strategy as OAuth2Strategy } from 'passport-oauth2'; // Import the necessary package
...
const verifyCallback: VerifyFunction = async (accessToken: string, refreshToken: string, profile: Profile, done: (error: any, user?: IUser | null) => void) => {

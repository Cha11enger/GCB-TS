...
const analyzeGithubUrl = async (req: Request, res: Response) => {
  ...
  try {
    ...
    // if repo is not epublic check the owner's access token in db and use it to authenticate and analyze the repo and if owner's access token is not found redirect to github auth
